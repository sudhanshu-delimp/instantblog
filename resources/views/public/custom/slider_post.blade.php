<div class="slider--content--wrapper">
    ...
    <div class="social--data">
        <ul>
            ...
            <li><a target="_blank" href="http://www.linkedin.com/shareArticle?url={{url('/posts/'.$slider_post->post_slug)}}&title={{$slider_post->post_title}}"><i class="fa-brands fa-linkedin-in"></i></a></li>
            <li><a target="_blank" href="https://twitter.com/share?url={{url('/posts/'.$slider_post->post_slug)}}&text={{$slider_post->post_title}}"><i class="fa-brands fa-twitter"></i></a></li>
