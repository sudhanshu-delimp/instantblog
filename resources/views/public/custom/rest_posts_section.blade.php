...
<li><a target="_blank" href="https://twitter.com/share?{{url('/posts/'.$rest_post->post_slug)}}&text={{$rest_post->post_title}}"><i class="fa-brands fa-linkedin-in"></i></a></li>
<li><a target="_blank" href="http://www.linkedin.com/shareArticle?url={{url('/posts/'.$rest_post->post_slug)}}&title={{$rest_post->post_title}}"><i class="fa-brands fa-twitter"></i></a></li>
